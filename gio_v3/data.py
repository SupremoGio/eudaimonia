...
QUOTES = [
    ...
    # ── Estoicas (ampliación) ─────────────────────────────────────────────────
    {"text": "How much more grievous are the consequences of anger than the causes of it.", "author": "Marco Aurelio · Meditaciones", "category": "stoic"},
    {"text": "Confine yourself to the present.", "author": "Marco Aurelio · Meditaciones", "category": "stoic"},
    {"text": "Everything we hear is an opinion, not a fact. Everything we see is a perspective, not the truth.", "author": "Marco Aurelio · Meditaciones", "category": "stoic"},
    {"text": "The best revenge is to be unlike him who performed the injury.", "author": "Marco Aurelio · Meditaciones", "category": "stoic"},
    {"text": "Accept the things to which fate binds you, and love the people with whom fate brings you together.", "author": "Marco Aurelio · Meditaciones", "category": "stoic"},
    {"text": "Reject your sense of injury and the injury itself disappears.", "author": "Marco Aurelio · Meditaciones", "category": "stoic"},
    {"text": "No great thing is created suddenly.", "author": "Epicteto · Discursos", "category": "stoic"},
    {"text": "It is impossible for a man to learn what he thinks he already knows.", "author": "Epicteto", "category": "stoic"},
    {"text": "Only the educated are free.", "author": "Epicteto", "category": "stoic"},
    {"text": "He is a wise man who does not grieve for the things which he has not, but rejoices for those which he has.", "author": "Epicteto", "category": "stoic"},
    {"text": "Circumstances don't make the man, they only reveal him to himself.", "author": "Epicteto", "category": "stoic"},
    {"text": "Any person capable of angering you becomes your master.", "author": "Epicteto", "category": "stoic"},
    {"text": "Difficulties are things that show what people are.", "author": "Epicteto", "category": "stoic"},
    {"text": "Seek not that the things which happen should happen as you wish; but wish the things which happen to be as they are.", "author": "Epicteto · Enquiridión", "category": "stoic"},
    {"text": "He who has learned to die has unlearned slavery.", "author": "Séneca · Cartas a Lucilio", "category": "stoic"},
    {"text": "Difficulties strengthen the mind, as labor does the body.", "author": "Séneca", "category": "stoic"},
    {"text": "It is not that we have a short time to live, but that we waste a lot of it.", "author": "Séneca · De la Brevedad de la Vida", "category": "stoic"},
    {"text": "While we wait for life, life passes.", "author": "Séneca", "category": "stoic"},
    {"text": "Every new beginning comes from some other beginning's end.", "author": "Séneca", "category": "stoic"},
    {"text": "Sometimes even to live is an act of courage.", "author": "Séneca", "category": "stoic"},
    {"text": "He suffers more than necessary, who suffers before it is necessary.", "author": "Séneca", "category": "stoic"},
    {"text": "True happiness is to enjoy the present, without anxious dependence upon the future.", "author": "Séneca", "category": "stoic"},
    {"text": "Associate with people who are likely to improve you.", "author": "Séneca · Cartas a Lucilio", "category": "stoic"},
    {"text": "Nothing proves a well-ordered mind so much as a man's ability to stop and pass time in his own company.", "author": "Séneca", "category": "stoic"},
    {"text": "As is a tale, so is life: not how long it is, but how good it is, is what matters.", "author": "Séneca", "category": "stoic"},
    {"text": "Adapt yourself to the things among which your lot has been cast.", "author": "Marco Aurelio · Meditaciones IV", "category": "stoic"},
    {"text": "Time is like a river made up of events, a violent stream; no sooner is a thing seen than it is carried away.", "author": "Marco Aurelio · Meditaciones IV", "category": "stoic"},
    {"text": "The universe is change; our life is what our thoughts make it.", "author": "Marco Aurelio · Meditaciones IV", "category": "stoic"},
    {"text": "Because a thing seems difficult for you, do not think it impossible for anyone to accomplish.", "author": "Marco Aurelio · Meditaciones", "category": "stoic"},
    {"text": "Man conquers the world by conquering himself.", "author": "Zenón de Citio", "category": "stoic"},
    {"text": "It is impossible for anyone to make progress while he is vacillating between opposite things.", "author": "Musonio Rufo", "category": "stoic"},
    {"text": "El hombre sabio no lamenta lo que no tiene, sino que se alegra por lo que tiene.", "author": "Epicteto", "category": "stoic"},
    {"text": "Ninguna gran cosa se crea de repente.", "author": "Epicteto", "category": "stoic"},
    {"text": "Lo único que es realmente nuestro son nuestras acciones y nuestros pensamientos.", "author": "Marco Aurelio", "category": "stoic"},
    {"text": "No hay viento favorable para el que no sabe a qué puerto se dirige.", "author": "Séneca · Cartas a Lucilio", "category": "stoic"},
    # ── Motivacionales (ampliación) ───────────────────────────────────────────
    ...
    {"text": "The best time to plant a tree was 20 years ago. The second best time is now.", "author": "Proverbio chino", "category": "motivational"},
    {"text": "I have not failed. I've just found 10,000 ways that won't work.", "author": "Thomas Edison", "category": "motivational"},
    ...
    {"text": "It is during our darkest moments that we must focus to see the light.", "author": "Aristóteles", "category": "motivational"},
    ...
    {"text": "The mind is everything. What you think you become.", "author": "Buda", "category": "motivational"},
    {"text": "An unexamined life is not worth living.", "author": "Sócrates", "category": "motivational"},
    ...
    {"text": "Fall seven times, stand up eight.", "author": "Proverbio japonés", "category": "motivational"},
    ...
    {"text": "Quality is not an act, it is a habit.", "author": "Aristóteles", "category": "motivational"},
    {"text": "Discipline equals freedom.", "author": "Jocko Willink", "category": "motivational"},
    {"text": "A ship in harbor is safe, but that is not what ships are built for.", "author": "John A. Shedd", "category": "motivational"},
    {"text": "Someone's sitting in the shade today because someone planted a tree a long time ago.", "author": "Warren Buffett", "category": "motivational"},
    {"text": "Genius is 1 percent inspiration and 99 percent perspiration.", "author": "Thomas Edison", "category": "motivational"},
