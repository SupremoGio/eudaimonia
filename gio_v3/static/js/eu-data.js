...
window.EU = {
  ...
  modules: [
    { id:'hegemonikon',    name:'HEGEMONIKON',    concept:'Bienestar',      desc:'Salud · Nutrición · Perfil',  hue:45,  route:'/bienestar',   streak:0, done:false },
    ...
    { id:'paideia',        name:'PAIDEIA',        concept:'Conocimiento',   desc:'Aprendizaje · Libros',        hue:265, route:'/paideia',     streak:0, done:false },
    ...
    { id:'eurythmia',      name:'EURYTHMIA',      concept:'Baile',          desc:'Baile · Ritmo · Cuerpo',      hue:330, route:'/eurythmia',   streak:0, done:false },
  ],
