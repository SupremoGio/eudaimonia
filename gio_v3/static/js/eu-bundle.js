...
function ModuleExtra({
  ...
  if (id === 'hegemonikon') {
    ...
    const subs = [{
      ...
      icon: '👔',
      label: 'Guardarropa',
      sub: 'Outfits · Presencia'
    }, {
      href: '/recetas/',
      icon: '🍳',
      label: 'Recetas',
      sub: 'Cocina inteligente'
    }, {
      href: '/perfil/',
      icon: '👤',
      label: 'Perfil',
    ...
    }, "Métricas Corporales"), rows.map((r, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: 'flex',
        justifyContent: 'space-between',
    ...
    }, r.val), r.sub && /*#__PURE__*/React.createElement("div", {
      style: {
        fontFamily: 'DM Sans,sans-serif',
        fontSize: 9,
        color: C.textMuted
  ...
  if (id === 'ataraxia') {
    ...
    }, "Submódulos"), mkLink('/ataraxia/', '⚓', 'Ataraxia', 'Checklist semanal · Orden'), mkLink('/sabado/', '🧹', 'Sábado Reset', 'Ritual matutino de limpieza'), mkLink('/gtd/', '🎯', 'Praxis GTD', 'Inbox · Next Actions · Proyectos'));
  }
  if (id === 'logoi') {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
